...
var client = LineBot.client({
  channelID: '1475779773',
  channelSecret: '93e2fae7108bbb794f642c28327f9d53',
  channelMID: 'u73f216bd41a3cfe439fd262ffd27e18f'
});
...
app.post('/', function (req, res) {
  ...
  _.each(receives, function(receive){
   ...
   console.log('optType ==> ', receive.getFromMid()  ,' ==> ', req.body.result[0].content.opType); 

   if(req.body.result[0].content.opType===4){
      client.getUserProfile(receive.getFromMid())
            .then(function onResult(res){
              if(res.status === 200){
                var contacts = res.body.contacts;
                if(contacts.length > 0){
                  client.sendText(receive.getFromMid(), 'Hi! Thank you very much for adding me. I am echobot lynnnay. Welcome!! ' + contacts[0].displayName);
                }
              }
